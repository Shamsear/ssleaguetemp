...
export default function PlayerDetailPage() {
    ...
    const fetchPlayerData = async () => {
      ...
      try {
        ...
        if (playerData.success && playerData.data.player) {
          ...
          const historyResponse = await fetchWithTokenRefresh(`/api/players/${playerId}/history`, {
            headers: { 'Cache-Control': 'no-cache' },
          });
  ...
  const getPositionColor = (position: string) => {
    switch (position) {
      ...
      case 'QB': return 'bg-red-50 border border-red-200 text-red-800';
      case 'RB_nfl': return 'bg-blue-50 border border-blue-200 text-blue-800';
  ...
  const getUniqueRounds = () => {
    ...
    Object.values(auctionHistory.bidsBySeason).forEach(bids => {
      bids.forEach(bid => {
        if (bid.round_id) {
          rounds.add(bid.round_id.toString());
        }
      });
    });
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 font-mono">Loading player details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/dashboard/team/footballplayers" className="mt-4 inline-block text-amber-600 font-bold hover:underline">
            ...
            <div className="console-card bg-white border border-slate-200/60 rounded-3xl p-6 shadow-sm">
              ...
              <div className="space-y-2.5 text-xs border-t border-slate-100 pt-4 font-mono">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-extrabold text-slate-850">{player.nationality || 'N/A'}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-400 font-bold uppercase tracking-wider">Playing Style:</span>
                  <span className="font-extrabold text-slate-850">{player.playing_style || 'N/A'}</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3 font-mono">
                ...
                <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 shadow-inner">
                  ...
                  <p className="text-base font-extrabold text-slate-850">
                    {player.team && player.acquisition_value ? (
                      <span className="flex items-center gap-1 text-emerald-605 font-mono">
                ...
                {player.round_id && (
                  <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 shadow-inner">
                    ...
                    <p className="text-sm font-extrabold text-slate-805">
                                    ...
                                    >
                                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                        <div className="flex-1 min-w-0">
                                          ...
                                          <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 text-[10px] text-slate-405">
                                            <div className="flex items-center gap-2">
        ...
        {activeTab === 'history' && (
          <div className="space-y-6">
            {loadingHistory ? (
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-3 font-mono">
                                  ...
                                  {contract.status === 'swapped' && (
                                    <>
                                      <div className="flex items-center gap-1.5 mb-1.5">
                                        <svg className="w-4 h-4 text-blue-550" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                                        </svg>
                                  ...
                                  {contract.status === 'takeover' && (
                                    <>
                                      <div className="flex items-center gap-1.5 mb-1.5">
                                        <svg className="w-4 h-4 text-purple-550" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                                        </svg>
              ...
              <div className="console-card bg-white border border-slate-200/60 rounded-3xl p-12 text-center shadow-sm">
                <svg className="w-20 h-20 text-slate-200 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
