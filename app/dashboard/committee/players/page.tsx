...
export default function CommitteePlayersPage() {
  ...
  const handleExportToExcel = async () => {
    try {
      ...
      // Define custom list of targets in requested order
      const targets = [
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="console-card bg-white rounded-2xl p-6 md:p-8 max-w-3xl w-full shadow-2xl border border-slate-200/60 font-mono flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
              ...
              {/* Right Column: Columns Selector */}
              <div className="md:col-span-3 flex flex-col space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-bold text-slate-600 uppercase tracking-wider">
                    2. Select Columns ({selectedExportColumns.length}/{ALL_EXPORT_COLUMN_KEYS.length})
                  </span>
                ...
                {/* Checklist Container */}
                <div className="max-h-[280px] overflow-y-auto pr-1 border border-slate-200 rounded-xl p-3 bg-slate-50/50 space-y-4">
                          ...
                          <button
                            onClick={() => {
                              if (isAllCatChecked) {
                                ...
                                // add missing keys in this category
