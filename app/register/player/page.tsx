...
function PlayerSearchContent() {
  ...
  const searchPlayers = useCallback(async (term: string) => {
    ...
    setSearching(true)
    try {
      // Use API endpoint for optimized search with no caching to ensure fresh data
  ...
  // Add debounce state - optimized to 200ms for dynamic API matching
  useEffect(() => {
    ...
    <div className="console-bg min-h-screen text-slate-800 relative pt-5 lg:pt-24 pb-8 sm:pb-12 px-4 sm:px-6">
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-6 font-mono">
        ...
        <div className="console-card bg-white rounded-2xl p-6 shadow-sm border border-slate-200/60 overflow-hidden">
          ...
          {!user ? (
            <div className="bg-gradient-to-r from-blue-50/50 to-cyan-50/50 rounded-xl p-6 border border-blue-200/40 text-slate-800">
