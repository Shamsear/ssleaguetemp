...
async function previewRefundBlueStrikers() {
    ...
    try {
        ...
        console.log(`   Real Player Budget: €${currentRealplayerBudget.toFixed(2)} → €${newRealplayerBudget.toFixed(2)} (+€${REFUND_AMOUNT})`);
        console.log(`   Real Player Spent: €${currentRealplayerSpent.toFixed(2)} → €${newRealplayerSpent.toFixed(2)} (-€${REFUND_AMOUNT})\n`);
        ...
        console.log(`   Fields: team_id, team_name, season_id, amount, type, description, created_at`);
        console.log('');
        console.log('='.repeat(70));
        ...
        console.log('  node scripts/refund-blue-strikers-firebase.js');
